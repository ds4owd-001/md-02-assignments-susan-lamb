...
> *Question 4 answer:*
>
> *geom_bar() function automatically plots the data by counts. One can also do this by using geom_col(), but they must explicitly set the y axis to = counts.*
...
> *Quote 7:*
>
> *The 'breaks' argument creates an outline around each series in the bar chart. The seq() parameter sets the (lower x limit, the upper x limit, and the width of the bar).*

```{r}
ggplot(data = gapminder_2007,
       mapping = aes(x = lifeExp,
                     fill = continent)) +
  geom_histogram(col = "gray30", breaks = seq(40, 85, 2.5))
```
...
> *Question 4 answer:*
>
> *country_colors are "color schemes for the countries and continents in the Gapminder data"*
